...
public class FastDatePrinter implements DatePrinter, Serializable {
     ...
     */
    private static String getTimeZoneDisplay(final TimeZone tz, final boolean daylight, final int style, final Locale locale) {
    ...
    /**
     * Initializes the instance for start use.
     */
    private void init() {
     ...
     */
    private NumberRule selectNumberRule(final int field, final int padding) {
        switch (padding) {
            case 1:
     ...
     */
    StringBuffer applyRules(final Calendar calendar, final StringBuffer buf) {
