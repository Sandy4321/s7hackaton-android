...
public class FastDateFormat extends Format implements DateParser, DatePrinter {
     ...
     * @throws NullPointerException if pattern, timeZone, or locale is null.
     */
    private FastDateFormat(final String pattern, final TimeZone timeZone, final Locale locale, final Date centuryStart) {
     ...
     *                                  pattern defined
     */
    private static FastDateFormat getDateTimeInstance(
