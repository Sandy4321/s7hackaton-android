...
interface DateParser {
     ...
     * @throws ParseException if the beginning of the specified string cannot be parsed.
     * @see java.text.DateFormat#parseObject(String) java.text.DateFormat#parseObject(String)java.text.DateFormat#parseObject(String)java.text.DateFormat#parseObject(String)java.text.DateFormat#parseObject(String)java.text.DateFormat#parseObject(String)
     */
     ...
     * @return a <code>java.util.Date</code> object
     * @see java.text.DateFormat#parseObject(String, ParsePosition) java.text.DateFormat#parseObject(String, ParsePosition)java.text.DateFormat#parseObject(String, ParsePosition)java.text.DateFormat#parseObject(String, ParsePosition)java.text.DateFormat#parseObject(String, ParsePosition)java.text.DateFormat#parseObject(String, ParsePosition)
     */
